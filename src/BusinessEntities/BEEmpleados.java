...
public class BEEmpleados {
    ...
    public BEEmpleados(int emp_id, int car_id, String empnombres, String empapellidos, String empsexo, Blob empfoto, Date empfechanac, int gen_id, int doc_id, int empnumerodoc, String empdireccion, int emptelefono, String empemail, String empacceso, String empcredencial, Date empfechareg, int empestado) {
        this.emp_id = emp_id;
        this.car_id = car_id;
    ...
    public Blob getEmpfoto() {
        return empfoto;
    }

    public void setEmpfoto(Blob empfoto) {
        this.empfoto = empfoto;
    }
